  ...
  <?php
		...
		?>
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/update_product',$edit_product_info->product_id)}}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
						  <fieldset>
						...
						<div class="control-group">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="product_short_description" rows="3" >{{$edit_product_info->product_short_description}}</textarea>
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="product_long_description" rows="3">{{$edit_product_info->product_long_description}}</textarea>
							  </div>
							</div>
